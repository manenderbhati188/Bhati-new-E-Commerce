    ...
    <div className="productdisplay">
      ...
      <div className="productdisplay-right">
        ...
        <div className="product_discription">
          A classic cotton T-shirt is a wardrobe staple known for its softness
          and breathability, making it perfect for casual, everyday wear. Its
          simple, versatile design can be dressed up or down, providing comfort
          and ease of movement. Paired with jeans or layered under a jacket, it
          offers a timeless, effortless style
        </div>
